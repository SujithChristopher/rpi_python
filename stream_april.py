            ...
            if self.FIRST_FRAME:
                ...
                if (ids is not None and len(ids) > 0) and all(
                    ...
                    if self.first_vec:
                        ...
                        # Compute the Euclidean distance between the current and previous vectors
                        norm = np.linalg.norm(self.current_vec - self.previous_vec)
                        
                        # Set a threshold for jitter reduction
                        if norm > 1:  # Adjust this threshold based on the specific context
                        ...
                        # Update the previous vector for the next iteration
